...
const Restaurant7 = () => {
    ...
    const getData1 = async () => {
        ...
        const distance1 = Math.abs(location7-location6)
        const distance2 = Math.abs(location7-location5)
        const distance3 = Math.abs(location7-location4)

  return (
      <div>
        <h1 className='title'>Restaurant "R2"</h1>
        <div className='contImage'>
            <img src={require('../img/r2.jpg')} className='pic'/>
            <div className='txtCont'>
                <p> Distance between Restaurant R2 and U is {distance1} km. Distance between Restaurant R2 and A is {distance2} km. Distance between Restaurant R2 and T is {distance3} km </p>
