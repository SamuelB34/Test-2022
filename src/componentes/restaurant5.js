...
const Restaurant5 = () => {
    ...
    const getData1 = async () => {
        ...
        const distance1 = Math.abs(location5-location4)
        const distance2 = Math.abs(location5-location6)
        const distance3 = Math.abs(location5-location7)

  return (
      <div>
        <h1 className='title'>Restaurant "A"</h1>
        <div className='contImage'>
            <img src={require('../img/a.jpg')} className='pic'/>
            <div className='txtCont'>
                <p> Distance between Restaurant A and T is {distance1} km. Distance between Restaurant A and U is {distance2} km. Distance between Restaurant A and R is {distance3} km </p>
