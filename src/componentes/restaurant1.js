...
const Restaurant1 = () => {
  ...
  return (
      <div>
        <h1 className='title'>Restaurant "R"</h1>
        <div className='contImage'>
            <img src={require('../img/r.jpg')} className='pic'/>
            <div className='txtCont'>
                <p> Distance between Restaurant R and E is {distance1} km. Distance between Restaurant R and S is {distance2} km. Distance between Restaurant R and T is {distance3} km </p>
