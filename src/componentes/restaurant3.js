...
const Restaurant3 = () => {
    ...
    const getData1 = async () => {
        ...
        const distance1 = Math.abs(location3-location2)
        const distance2 = Math.abs(location4-location3)
        const distance3 = Math.abs(location5-location4)

  return (
      <div>
        <h1 className='title'>Restaurant "S"</h1>
        <div className='contImage'>
            <img src={require('../img/s.jpg')} className='pic'/>
            <div className='txtCont'>
                <p> Distance between Restaurant S and E is {distance1} km. Distance between Restaurant S and T is {distance2} km. Distance between Restaurant S and A is {distance3} km </p>
